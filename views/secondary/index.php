<h1 class="section_title">Cycle Secondaire</h1>

<div class="grid_container">
    <div class="article">
        <div class="article_image">
            <a href="<?= PRE ?>/schedule/cycle/2"><img src="<?= PRE ?>/res/images/timetable.png" onerror="this.src='/tdw/res/images/default.png';"></a>
        </div>
        <div class="article_text">
            <h3><a href="<?= PRE ?>/schedule/cycle/2">Emplois du temps</a></h3>
            <p>Consulter tous les horaires d'études des élèves du secondaire</p>
            <a href="<?= PRE ?>/schedule/cycle/2"">Voir les horaires →</a>
        </div>
    </div>
    <div class="article">
        <div class="article_image">
...
<h1 class="section_title">Actualités du secondaire</h1>
...
<div class="pages">
    ...
    <?php for($i = 1; $i <= $pages; $i++): ?>
        <?php if($i == $page): ?>
            <a data-current="true" href="<?= PRE ?>/secondary/index/<?= $i ?>"><span><?= $i ?></span></a>
            <?php continue; ?>
        <?php endif; ?>
        <a href="<?= PRE ?>/secondary/index/<?= $i ?>"><span><?= $i ?></span></a>
    <?php endfor; ?>
</div>
